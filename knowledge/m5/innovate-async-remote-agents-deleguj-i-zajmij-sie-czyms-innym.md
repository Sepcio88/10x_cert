...
Trzy tryby mówią, _kiedy_ odzyskujesz kontrolę. Zostaje pytanie, _co_ właściwie oddajesz Agentowi do zrobienia bez nadzoru. Najczęściej nie jest to luźny prompt, tylko plan, który już masz.
...
Krótka uwaga o zaliczeniu: ta lekcja jest rozszerzeniem (_Innovate_) i **nie jest osobną ścieżką na 10xChampion**. Odznakę modułową zdobywasz pipeline'em (M5L2/M5L3) albo rejestrem artefaktów (M5L4); poniższe zadanie rób dla samej praktyki pracy zdalnej i asynchronicznej (odznakę _za tę lekcję_ odbierzesz niżej jak zwykle).
...
- Prework [\[1.2\]](https://platforma.przeprogramowani.pl/external/10xdevs-3-prework/pl/02) _Chatbot vs Agent vs Harness_ — słownictwo harnessu, narzędzi i kontroli, które ta lekcja pogłębia.
- Prework [\[2.1\]](https://platforma.przeprogramowani.pl/external/10xdevs-3-prework/pl/04) _Agent w IDE, Terminalu czy w Chmurze?_ — punkt startowy do porównania środowisk pracy.
- Prework [\[2.4\]](https://platforma.przeprogramowani.pl/external/10xdevs-3-prework/pl/07) _Agent-Native IDE_ — założenia o pracy w tle, mobilności, review, sekretach i kosztach.
- Prework [\[3.3\]](https://platforma.przeprogramowani.pl/external/10xdevs-3-prework/pl/11) _Cykl życia wątku i zarządzanie kontekstem_ — kontekst, izolacja i pamięć zewnętrzna jako fundament pętli oraz pracy asynchronicznej.
